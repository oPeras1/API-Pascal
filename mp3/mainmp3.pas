...
procedure MP3Player;
  begin
	  ...
	  Delay(100);
          ...
          cursorp:=1;
          GotoXY(WindMaxX div 4,cursorp+18);      //Escolher as opções apartir das "arrow keys", definir cor ciano para a opcao pre-selecionada e cor default para a que deixou de ser pre-selecionada
          TextColor(cyan);
