...
procedure MP3Player;
  begin
	  ...
	  Delay(100);
          ...
          writeln;
          im1:=1;
          opcoesescolhiveismp3[1]:='Fui ao Jardim da Celeste';       //Definir todas as opções
          opcoesescolhiveismp3[2]:='Sou uma Taça';
          opcoesescolhiveismp3[3]:='É Natal';
          opcoesescolhiveismp3[4]:='Música de Elevador';
          opcoesescolhiveismp3[5]:='Verão e Amor';
          opcoesescolhiveismp3[6]:='Nenhuma';
          while (im1<=length(opcoesescolhiveismp3)) do  //'Animações das opções disponiveis e o seu centramento
            begin
              writeln;
              GotoXY(10,WhereY);
          ...
          cursorp:=1;
          GotoXY(10,cursorp+18);      //Escolher as opções apartir das "arrow keys", definir cor ciano para a opcao pre-selecionada e cor default para a que deixou de ser pre-selecionada
          TextColor(cyan);
          writeln(opcoesescolhiveismp3[cursorp]);
          opcaopescolhermp3:=true;
          window(90,19, WindMaxX, WindMaxY);
          TextColor(black);
          im1:=1;
          opcoesdasopcoes[1]:='Volume da Música: '+VarToStr(volume)+'%';       //Definir todas as opções
          opcoesdasopcoes[2]:='         Em Loop: [ ]';
          if (musicaloop) then
            opcoesdasopcoes[2]:='         Em Loop: [X]';
          opcoesdasopcoes[3]:=' Música Ambiente: [X]';
          if (not musicaambiente) then
            opcoesdasopcoes[3]:=' Música Ambiente: [ ]';
          opcoesdasopcoes[4]:='               Voltar';
          GotoXY(1,1);
          while (im1<=length(opcoesdasopcoes)) do  //'Animações das opções disponiveis e o seu centramento
            begin
                      ...
                      case cursorp of
                        1:
                         begin
                           ...
                           GotoXY(1,cursorp*2-1);
                           InsLine;
                           writeln('Volume da Música: ');
                           DelLine;
                           cursoron;
                           GotoXY(19,cursorp*2-1);
                           volumeantigo:=volume;
                           readln(volume);
                           cursoroff;
                           ...
                           GotoXY(1,cursorp*2-1);
                           opcoesdasopcoes[1]:='Volume da Música: '+VarToStr(volume)+'%     ';
                           write('Volume da Música: ',volume,'%');
                         end;
                        2:
                         begin
                           window(90,19, WindMaxX, WindMaxY);
                         ...
                         begin
                           ...
                           if (musicaambiente) then
                             begin
                               ...
                               opcoesdasopcoes[cursorp]:=' Música Ambiente: [ ]';
                             end
                           else
                             begin
                               musicaambiente:=true;
                               opcoesdasopcoes[cursorp]:=' Música Ambiente: [X]';
                             end;
                           writeln(opcoesdasopcoes[cursorp]);
                         end;
                        4:
